      ...
      <div className="flex items-stretch gap-1.5 mt-1">
        <div className="flex items-stretch gap-0.5 text-base text-[#201F23] font-normal tracking-[0.48px] leading-loose grow shrink basis-auto">
          <div className="justify-between items-center flex gap-[40px_95px] grow shrink basis-auto bg-white pl-[17px] pr-[5px] py-[5px] rounded-[135.875px]">
            <input
              ...
              className="text-[#201F23] w-[159px] bg-transparent border-none outline-none"
              aria-label="Search businesses"
            />
            <button aria-label="Search">
              <img
                src="https://cdn.builder.io/api/v1/image/assets/8b21ee557b7745c5a48d7a254ebad4cd/d42043c1faabef2e58495d4a5c68e42886918947?placeholderIfAbsent=true"
                alt="Search"
          ...
          <button aria-label="User profile">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/8b21ee557b7745c5a48d7a254ebad4cd/68a44f3e8cbef428e59761c7960e116e0340a552?placeholderIfAbsent=true"
              alt="User profile"
              className="aspect-[1] object-contain w-[53px] rounded-[75px]"
            />
          </button>
        </div>
        <div className="flex items-stretch gap-[25px] my-auto">
          <button aria-label="Notifications">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/8b21ee557b7745c5a48d7a254ebad4cd/519724bfe5810b747ca6a8ab1a6e907b793fd507?placeholderIfAbsent=true"
              alt="Notifications"
              className="aspect-[0.96] object-contain w-[25px]"
            />
          </button>
          <button aria-label="Settings">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/8b21ee557b7745c5a48d7a254ebad4cd/7572614c1490e0417b8ae9ea47bc0122defbdd06?placeholderIfAbsent=true"
              alt="Settings"
              className="aspect-[1] object-contain w-[42px] rounded-[83px]"
            />
          </button>
        </div>
      </div>
